			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					@else
						...
						<li><a href="{{ url('my/stories') }}"><i class="glyphicon glyphicon-file"></i> My Stories</a></li>
						<li><a href="{{ url('/story/create') }}"><i class="glyphicon glyphicon-plus"></i> New Story</a></li>
						<li class="dropdown">
